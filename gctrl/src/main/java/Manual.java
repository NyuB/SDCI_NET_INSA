	...
	public static void main(String[] args) throws IOException {
		...
		while ((line = askNextLine(in)) != null && !line.equals("")) {
			...
			if (cmd.length == 0) {
				...
				VnfConfigAPIEndpoint endpoint = new VnfConfigAPIEndpoint("http://" + ipVnf + ":8888");
				...
				sdnCtrlAPI.vnfInTheMiddle(ryu, dpid, outputPort, inputPort, ipFrom, ipMid, ipTo, portMid, 0);
